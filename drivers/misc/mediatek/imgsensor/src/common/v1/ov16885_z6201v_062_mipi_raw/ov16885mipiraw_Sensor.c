...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16885_Z6201V_062_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {
	...
	{0x02, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 ...
	 0x01, 0x2b, 0x168, 0x36c, 0x03, 0x00, 0x0000, 0x0000},
	/* Video mode setting */
	{0x02, 0x0a, 0x00, 0x08, 0x40, 0x00,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4BlockNumX = 144,
	.i4BlockNumY = 109,
	.i4PosR = {{46, 2}, {62, 2}, {38, 14}, {54, 14}, {46, 18}, {62, 18}, {38, 30}, {54, 30},},
	.i4PosL = {{46, 6}, {62, 6}, {38, 10}, {54, 10}, {46, 22}, {62, 22}, {38, 26}, {54, 26},},
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x5021, 0x30);
	write_cmos_sensor(0x5022, 0x12);
	write_cmos_sensor(0x5023, 0x30);
	...
	write_cmos_sensor(0x59c5, 0x30);
	write_cmos_sensor(0x59c6, 0x12);
	write_cmos_sensor(0x59c7, 0x30);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x366c, 0x13);
	write_cmos_sensor(0x4643, 0x02);
	write_cmos_sensor(0x4640, 0x00);
	write_cmos_sensor(0x4641, 0x24);
	write_cmos_sensor(0x4642, 0x62);
	write_cmos_sensor(0x4645, 0x04);
	write_cmos_sensor(0x4813, 0x98);
	write_cmos_sensor(0x0304, 0x50);
	write_cmos_sensor(0x4837, 0x0a);
	write_cmos_sensor(0x3666, 0xad);

	/*PD VC*/
	write_cmos_sensor(0x3661, 0x0f);
	write_cmos_sensor(0x480e, 0x07);
	write_cmos_sensor(0x4809, 0x2b);
}
...
UINT32 OV16885_Z6201V_062_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
