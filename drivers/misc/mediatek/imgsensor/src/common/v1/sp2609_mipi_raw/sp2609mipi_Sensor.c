...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x9d, 0x1a);/*MIPI sequence*/
	...
	write_cmos_sensor(0x03, 0x3f);/*0x7f*/
	write_cmos_sensor(0xbc, 0x40);
	write_cmos_sensor(0xbd, 0x30);
	write_cmos_sensor(0xbe, 0x6f);
	write_cmos_sensor(0xbf, 0x0b);
	write_cmos_sensor(0xc5, 0x01);/*0x02*/
	write_cmos_sensor(0xc6, 0x6f);/*0xdf*/
	write_cmos_sensor(0xc7, 0x01);/*0x02*/
	write_cmos_sensor(0xc8, 0x6d);/*0xdd*/
	write_cmos_sensor(0xcb, 0x6f);
	write_cmos_sensor(0xcc, 0x0b);
	write_cmos_sensor(0x04, 0x74);/*0x11*/
	write_cmos_sensor(0x05, 0x22);/*0x11*/
...
UINT32 SP2609_MIPI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
