...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 2608, 1960, 8, 8, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0, 0, 2592, 1944},/*Pre 2112*1558*/
	{ 2608, 1960, 8, 8, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0, 0, 2592, 1944},/*cap 4206*3128*/
	{ 2608, 1960, 8, 8, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0, 0, 2592, 1944},/* video */
	{ 2608, 1960, 8, 8, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0, 0, 2592, 1944},/*HighSpeedVideo*/
	{ 2608, 1960, 8, 8, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0, 0, 2592, 1944},/* slim video*/
};
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			LOG_INF("superpix Read sensor id fail,write id: 0x%x,id:0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
UINT32 SP5508_MIPI_RAW_Z620DL_094_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
