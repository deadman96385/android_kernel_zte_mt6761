...
{
	LCM_LOGI("%s: kernel ----zte_monkeyxm_ft8006p_720p_6p_lead_drv----\n", __func__);
...
struct LCM_DRIVER zte_monkeyxm_ft8006p_720p_6p_lead_lcm_drv = {
	.name = "zte_monkeyxm_ft8006p_720p_6p_lead_drv",
