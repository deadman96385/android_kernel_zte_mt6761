...
static bool start_test_ft8739(void)
{
	...
	for (item_count = 0; item_count < test_data.test_num; item_count++) {
		...
		if (item_code == CODE_FT8739_ENTER_FACTORY_MODE) {
		...
		/* FT8739_SHORT_TEST */
		if (item_code == CODE_FT8739_SHORT_CIRCUIT_TEST) {
		...
		/* FT8739_Open_TEST */
		if (item_code == CODE_FT8739_OPEN_TEST) {
		...
		/* FT8739_CB_TEST */
		if (item_code == CODE_FT8739_CB_TEST) {
		...
		/* FT8739_RAWDATA_TEST */
		if (item_code == CODE_FT8739_RAWDATA_TEST) {
		...
		if (item_code == CODE_FT8739_LCD_NOISE_TEST) {
