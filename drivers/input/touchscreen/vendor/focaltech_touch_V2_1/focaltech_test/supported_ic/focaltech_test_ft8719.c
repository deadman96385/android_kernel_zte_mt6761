...
static bool start_test_ft8719(void)
{
	...
	for (item_count = 0; item_count < test_data.test_num; item_count++) {
		...
		if (item_code == CODE_FT8719_ENTER_FACTORY_MODE) {
		...
		/* FT8719_SHORT_TEST */
		if (item_code == CODE_FT8719_SHORT_CIRCUIT_TEST) {
		...
		/* FT8719_Open_TEST */
		if (item_code == CODE_FT8719_OPEN_TEST) {
		...
		/* FT8719_CB_TEST */
		if (item_code == CODE_FT8719_CB_TEST) {
		...
		/* FT8719_RAWDATA_TEST */
		if (item_code == CODE_FT8719_RAWDATA_TEST) {
		...
		if (item_code == CODE_FT8719_LCD_NOISE_TEST) {
