...
struct test_funcs {
	...
	int (*get_tp_rawdata)(char *buffer, int length);
};
...
#define TEST_RESULT_LENGTH (16 * 1024)
#define TEST_TEMP_LENGTH 16
/*-----------------------------------------------------------
...
#define FTS_TEST_DBG(fmt, args...) pr_notice("[FTS] [TEST]%s. line: %d. "fmt"\n", __func__, __LINE__, ##args)
#define FTS_TEST_FUNC_ENTER() pr_notice("[FTS][TEST]%s: Enter(%d)\n", __func__, __LINE__)
#define FTS_TEST_FUNC_EXIT()  pr_notice("[FTS][TEST]%s: Exit(%d)\n", __func__, __LINE__)
#else
...
#define FTS_TEST_INFO(fmt, args...) pr_notice("[FTS][TEST][Info]%s. line: %d. "fmt"\n",  __func__, __LINE__, ##args)
#define FTS_TEST_ERROR(fmt, args...) pr_err("[FTS][TEST][Error]%s. line: %d. "fmt"\n",  __func__, __LINE__, ##args)
