...
#define FTS_DEBUG(fmt, args...) pr_notice("[FTS][%s]"fmt"\n", __func__, ##args)
#else
#define FTS_DEBUG(fmt, args...) pr_notice("[FTS]"fmt"\n", ##args)
#endif
#define FTS_FUNC_ENTER() pr_notice("[FTS]%s: Enter\n", __func__)
#define FTS_FUNC_EXIT()  pr_notice("[FTS]%s: Exit(%d)\n", __func__, __LINE__)
...
#define FTS_DBG(fmt, args...) pr_debug("[FTS][DBG]"fmt"\n", ##args)
#define FTS_INFO(fmt, args...) pr_notice("[FTS][Info]"fmt"\n", ##args)
#define FTS_ERROR(fmt, args...) pr_err("[FTS][Error]"fmt"\n", ##args)
